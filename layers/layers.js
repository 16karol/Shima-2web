...
lyr_GoogleSatellite_0.setVisible(true);lyr_DEM_1.setVisible(true);lyr_acc_2.setVisible(true);lyr_dir_3.setVisible(true);lyr_fill_4.setVisible(true);lyr_c_shp_5.setVisible(true);lyr_c_acc_6.setVisible(true);lyr_c_cauce_7.setVisible(true);lyr_Centroides_8.setVisible(true);lyr_c_curvas_9.setVisible(true);lyr_c_fill_10.setVisible(true);lyr_c_reclass_11.setVisible(true);lyr_c_rios_12.setVisible(true);lyr_sub_cuencas_13.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_DEM_1,lyr_acc_2,lyr_dir_3,lyr_fill_4,lyr_c_shp_5,lyr_c_acc_6,lyr_c_cauce_7,lyr_Centroides_8,lyr_c_curvas_9,lyr_c_fill_10,lyr_c_reclass_11,lyr_c_rios_12,lyr_sub_cuencas_13];
lyr_c_shp_5.set('fieldAliases', {'ID': 'ID', 'VALUE': 'VALUE', 'NAME': 'NAME', 'Area': 'Area', 'Perimetro': 'Perimetro', });
lyr_Centroides_8.set('fieldAliases', {'fid': 'fid', 'SEGMENT_ID': 'SEGMENT_ID', 'NODE_A': 'NODE_A', 'NODE_B': 'NODE_B', 'BASIN': 'BASIN', 'ORDER': 'ORDER', 'ORDER_CELL': 'ORDER_CELL', 'LENGTH': 'LENGTH', });
...
lyr_Centroides_8.set('fieldImages', {'fid': '', 'SEGMENT_ID': '', 'NODE_A': '', 'NODE_B': '', 'BASIN': '', 'ORDER': '', 'ORDER_CELL': '', 'LENGTH': '', });
lyr_c_curvas_9.set('fieldImages', {'fid': '', 'ID': '', 'CONTOUR': '', 'LENGTH': '', });
lyr_c_rios_12.set('fieldImages', {'SEGMENT_ID': '', 'NODE_A': '', 'NODE_B': '', 'BASIN': '', 'ORDER': '', 'ORDER_CELL': '', 'LENGTH': '', });
lyr_c_shp_5.set('fieldLabels', {'ID': 'no label', 'VALUE': 'no label', 'NAME': 'no label', 'Area': 'no label', 'Perimetro': 'no label', });
lyr_Centroides_8.set('fieldLabels', {'fid': 'no label', 'SEGMENT_ID': 'no label', 'NODE_A': 'no label', 'NODE_B': 'no label', 'BASIN': 'no label', 'ORDER': 'no label', 'ORDER_CELL': 'no label', 'LENGTH': 'no label', });
